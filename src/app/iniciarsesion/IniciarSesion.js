...
export default function IniciarSesion() {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-[url('/fondoSesion.png')] flex items-center justify-center">
      ...
      <form className="bg-night bg-opacity-95 p-8 sm:p-14 rounded-3xl flex flex-col items-center space-y-6 w-4/5 sm:w-[600px] lg:w-[700px]">
  ...
  Iniciar sesión
        ...
        <input type="password" placeholder="🔒 Contraseña" value={contraseña} onChange={(e)=> setContraseña(e.target.value)} required className="w-full p-4 rounded-md text-black bg-white text-lg" />
